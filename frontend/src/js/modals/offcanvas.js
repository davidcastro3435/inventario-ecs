  ...
  if (btnCreate) {
    btnCreate.addEventListener("click", () => {
      const offcanvas = new bootstrap.Offcanvas(
        document.getElementById("offcanvasCreateItem"),
      );
      offcanvas.show();
      ...
      if (categoriaSelect) {
        obtenerCategoriasAPI()
          .then((data) => {
            ...
            if (Array.isArray(data)) {
              data.forEach((cat) => {
                ...
                option.value =
                  cat.id_categoria || cat._id || cat.id || cat.nombre;
          ...
          .catch(() => {
            categoriaSelect.innerHTML =
              '<option value="" disabled selected>No se pudieron cargar categorías</option>';
          });
      }
    });
  }
  ...
  if (tbody) {
    tbody.addEventListener("click", async (e) => {
      ...
      try {
        ...
        const offcanvasEdit = new bootstrap.Offcanvas(
          document.getElementById("offcanvasEditItem"),
        );
        offcanvasEdit.show();
        ...
        document.getElementById("edit-cantidad-minima").value =
          item.alarma || "";
